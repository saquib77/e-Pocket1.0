  ...
  <nav class="navbar navbar-default">
      <div class="container">
          <div class="navbar-header">
              ...
              <a class="navbar-brand" href="/ep/">e-Pocket</a>
          </div>
          <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li><a href="/ep/">Home</a></li>
                <li><a style="color: black" href="AboutUs">About Us</a></li>
  ...
  <div class="container">
      ...
      <div class="card">
          <div class="title" style="text-align: center">
              <h3><strong>e-Pocket</strong></h3>
              <h4>e-Pocket is Developed by Group of Friends and It was build for College Project</h4>
          </div>
      </div>
        </div><!-- /.container -->
        <footer class="footer">
